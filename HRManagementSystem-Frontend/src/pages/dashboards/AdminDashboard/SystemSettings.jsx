    ...
    >
        <div className="p-8">
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-white/30 dark:border-gray-700/30 p-6 rounded-lg shadow-xl">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Platform Configuration</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">General</label>
                        <div className="flex items-center mt-2">
                            ...
                            />
                            <label htmlFor="publicRegistration" className="ml-2 block text-sm text-gray-900 dark:text-gray-200">
                                Allow public registration for new users
                            </label>
                        </div>
                        <div className="mt-4">
                            <label htmlFor="defaultUserRole" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Default New User Role</label>
                            <select
                    ...
                    <div className="border-t border-gray-200 pt-6">
                        ...
                        <div className="mt-2">
                            <label htmlFor="minPasswordLength" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Minimum Password Length</label>
                            <input
                                type="number"
                        ...
                        <div className="flex items-center mt-4">
                            <input
                                ...
                                className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                            />
                            <label htmlFor="twoFactorAuthEnabled" className="ml-2 block text-sm text-gray-900 dark:text-gray-200">
                    ...
                    <div className="border-t border-gray-200 pt-6">
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Notifications & Features</label>
                        <div className="flex items-center mt-2">
                            <input
                                type="checkbox"
                         ...
                         <div className="flex items-center mt-4">
                            ...
                            />
                            <label htmlFor="maintenanceMode" className="ml-2 block text-sm text-gray-900 dark:text-gray-200">
