...
const ProfilePage = () => {
  ...
  return (
    ...
    >
        <div className="p-8">
            <div className="mb-6">
                <Breadcrumb items={[{ label: 'Admin Dashboard', href: '/admin/dashboard' }, { label: 'My Profile' }]} />
            </div>
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-white/30 dark:border-gray-700/30 p-6 rounded-lg shadow-xl mb-8">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Admin Profile Information</h2>
                ...
                <form onSubmit={handleSaveProfile} className="space-y-6 max-w-xl">
                    ...
                    <div>
                        ...
                        />
                         <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Contact admin to change primary email.</p>
                    </div>
                    <div>
